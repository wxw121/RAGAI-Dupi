...
class UploadIntentCleanupServiceTest {
    ...
    void claimPersistsNonRunnableCleanupLeaseBeforeExternalObjectDeletion() {
        ...
        UploadIntentCleanupDecision decision = fixture.service.claim(fixture.reservation, Instant.now());
        ...
        var order = inOrder(fixture.jobs, fixture.quota);
        order.verify(fixture.jobs).findByIdForUpdate(fixture.job.getId());
        order.verify(fixture.quota).claimCleanupInCurrentTransaction(
                fixture.reservation, fixture.document.getId(), fixture.job.getClaimedBy(),
                fixture.job.getLeaseExpiresAt());
    ...
    void completeSerializesOnJobLockThenPersistsCleanupTruth() {
        ...
        when(fixture.documents.findById(fixture.document.getId())).thenReturn(Optional.of(fixture.document));
        ...
        var order = inOrder(fixture.jobs, fixture.outbox, fixture.quota, fixture.documents);
        order.verify(fixture.jobs).findByIdForUpdate(fixture.job.getId());
    ...
    void publishedOutboxWinsCleanupClaimWithoutChangingRunnableState() {
        ...
        verify(fixture.quota, never()).claimCleanupInCurrentTransaction(any(), any(), anyString(), any());
