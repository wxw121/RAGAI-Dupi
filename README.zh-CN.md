...
b> V1.4.1增加了持久的租户/用户上传配额、幂等的每个文件上传、可取消和租用的摄入执行、过时的回调保护和可选的webhook交付的重复数据删除终端故障事件。API版本：‘ 1.4.1-SNAPSHOT ’；Web版本：‘ 1.4.1 ’。
...
参见 [V1.4.1 版本运行手册](docs/zh-CN/v1.4.1-release-runbook.md) 和 [设计](docs/zh-CN/superpowers/specs/2026-07-18-v1.4.1-upload-governance-design.md)。最新的本地 V1.4.1 版本扫描记录图像摘要 `sha256:eec613fab9cdd1d873b95172f98d42ade5989238e2b0f76761b6b4f63b86515a`，图像大小 640,389,450 字节，没有 Python 发现，22 个接受的上游未修复 OS 发现将于 2026-08-15 到期。
