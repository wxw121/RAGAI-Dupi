...
- [ ] Pass API, Worker, Web, Pester, Compose, diff, and release-scan gates on the final release diff.
...
- [x] V1.5 P2: profile v2 filterable superset, Combined weighted RRF, revision-bound default quality gates, Web readiness/gate comparison -- 2026-07-19
