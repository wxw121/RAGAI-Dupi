...
- The release tag remains blocked until GitHub runs the repository's pinned Pester 4.10.1 contracts and every other CI job on the release commit, then repeats green on merged `main`.
