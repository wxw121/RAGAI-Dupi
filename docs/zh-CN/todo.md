...
- [x] V1.6a：结构化失败分类、运行聚合和 Web 可见性 — 2026-07-20
- [x] V1.6b：100 条真实查询基准，覆盖困难负样本、多文档来源断言和歧义问题 — 2026-07-20
- [x] V1.7：分类趋势、诊断下钻和发布质量门禁看板 — 2026-07-20
- [x] V1.8：检索参数实验、Profile A/B 对比和 RetrievalService 重构 — 2026-07-20
- [x] V1.9：发布 readiness、证据清单和阻断项 rollup — 2026-07-21
- [x] V2.0：真实查询反馈候选队列（由失败/退化评估信号生成）— 2026-07-21
- [x] V2.1：检索实验矩阵（TopK、Profile、检索模式、rerank 证据）— 2026-07-21
- [x] V2.2：答案质量代理指标（引用覆盖、grounded pass、幻觉风险）— 2026-07-21
...
- [x] 基于真实业务查询将基准从 30 条扩展到 100 条 — 2026-07-20
