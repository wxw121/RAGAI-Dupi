...
<!-- language-switch -->
[English](../../../en/superpowers/specs/2026-07-04-chat-session-history-design.md)
...
“GET / api / v1 /知识库/ {kbId} /聊天'

返回当前知识库下的会话摘要列表，按 `updatedAt` 倒序。

### 创建会话

' POST / api / v1 /知识库/ {kbId} /聊天'
...
“把/ api / v1 /知识库/ {kbId} /聊天/ {sessionId}’

返回会话元数据和消息列表。

### 重命名会话

“补丁/ api / v1 /知识库/ {kbId} /聊天/ {sessionId}’
...
“删除/ api / v1 /知识库/ {kbId} /聊天/ {sessionId}’

### 批量删除会话

的帖子/ api / v1 /知识库/ {kbId} /聊天/ batch-delete”
